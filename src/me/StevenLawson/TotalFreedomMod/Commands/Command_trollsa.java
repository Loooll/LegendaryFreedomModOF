...
@CommandParameters(description = "Troll annoying players asking for Super Admin!", usage = "/<command> [add:del] <player>")
public class Command_trollsa extends TFM_Command
{
